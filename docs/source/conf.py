...
# wine_project documentation build
...
from wine_project import __version__ as release

# -- Project information -----------------------------------------------------

project = "Wine Project MLOPS"
author = "Kedro"
